...
class Kalender
{
	...
	/* holt den Vormonat und das zugeh�rige Jahr unter Ber�cksichtigung des Jahressprung bei Januar
	 * R�ckgabewert:	Feld[2] -> Vormonat, zugeh�riges Jahr
	 */
	...
	/* holt den Nachmonat und das zugeh�rige Jahr unter Ber�cksichtigung des Jahressprung bei Dezember
	 * R�ckgabewert:	Feld[2] -> Nachmonat, zugeh�riges Jahr
	 */
	 ...
	 * Freie Felder vorher werden mit den letzten Monatstagen des Vormonats gef�llt und nachfolgende freie Felder mit dem Begin der Monatstage des Folgemonats.
	 * R�ckgabewert:	Feld[6][7] -> Vormonatstage, Monatstage, Folgemonatstage
	 */	
